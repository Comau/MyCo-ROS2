...
MycoEtherCATDriver::MycoEtherCATDriver(EtherCatManager *manager, std::string driver_name,const rclcpp::Node::SharedPtr& node):
    driver_name_(driver_name),ed_nh_(node)
{
    ...
    ed_nh_->declare_parameter("joint_names",std::vector<std::string>({"myco_joint2", "myco_joint1", "myco_joint3", "myco_joint4", "myco_joint5", "myco_joint6"}));
    ...
    if(!ed_nh_->has_parameter("axis_torque_factors"))
    {
        ...
        RCLCPP_ERROR(ed_nh_->get_logger(),"For more details: myco_robot_bringup/config/myco_drivers_example.yaml");
        exit(0);
    }
    ...
    for(int i=0; i<slave_no_.size(); i++)
    {
        ethercat_clients_[i]=new MycoEtherCATClient(manager, slave_no_[i], ed_nh_);
    }
    ...
    get_txpdo_server_=ed_nh_->create_service<std_srvs::srv::SetBool>("get_txpdo", std::bind(&MycoEtherCATDriver::getTxPDO_cb, this,std::placeholders::_1,std::placeholders::_2));
    get_rxpdo_server_=ed_nh_->create_service<std_srvs::srv::SetBool>("get_rxpdo", std::bind(&MycoEtherCATDriver::getRxPDO_cb, this,std::placeholders::_1,std::placeholders::_2));
    get_current_position_server_=ed_nh_->create_service<std_srvs::srv::SetBool>("get_current_position", std::bind(&MycoEtherCATDriver::getCurrentPosition_cb, this,std::placeholders::_1,std::placeholders::_2));
    get_motion_state_server_=ed_nh_->create_service<std_srvs::srv::SetBool>("get_motion_state", std::bind(&MycoEtherCATDriver::getMotionState_cb, this,std::placeholders::_1,std::placeholders::_2));
    get_pos_align_state_server_=ed_nh_->create_service<std_srvs::srv::SetBool>("get_pos_align_state", std::bind(&MycoEtherCATDriver::getPosAlignState_cb, this,std::placeholders::_1,std::placeholders::_2));
    enable_robot_=ed_nh_->create_service<std_srvs::srv::SetBool>("enable_robot", std::bind(&MycoEtherCATDriver::enableRobot_cb, this,std::placeholders::_1,std::placeholders::_2));
    disable_robot_=ed_nh_->create_service<std_srvs::srv::SetBool>("disable_robot", std::bind(&MycoEtherCATDriver::disableRobot_cb, this,std::placeholders::_1,std::placeholders::_2));
    clear_fault_=ed_nh_->create_service<std_srvs::srv::SetBool>("clear_fault", std::bind(&MycoEtherCATDriver::clearFault_cb, this,std::placeholders::_1,std::placeholders::_2));
    recognize_position_=ed_nh_->create_service<std_srvs::srv::SetBool>("recognize_position", std::bind(&MycoEtherCATDriver::recognizePosition_cb, this,std::placeholders::_1,std::placeholders::_2));
    ...
    status_timer_=ed_nh_->create_wall_timer(timeout, std::bind(&MycoEtherCATDriver::updateStatus,this));
...
void MycoEtherCATDriver::updateStatus()
{
...
bool MycoEtherCATDriver::getTxPDO_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::getRxPDO_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::getCurrentPosition_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::getMotionState_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::getPosAlignState_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::enableRobot_test()
{
    if(ethercat_clients_.size()==0)
    {
        return true;
...
bool MycoEtherCATDriver::enableRobot_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::disableRobot_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::clearFault_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
bool MycoEtherCATDriver::recognizePosition_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> req, const std::shared_ptr<std_srvs::srv::SetBool::Response> resp)
{
    if(!req->data)
    {
        resp->success=false;
...
void MycoEtherCATDriver::error_log(int line, std::string log, std::string log_param)
{
