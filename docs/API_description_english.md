...
example: function_pub_joints() in myco_basic_api/scripts/test.py
...
example: function_pub_cart() in myco_basic_api/scripts/test.py
...
example: function_pub_cart_path() in myco_basic_api/scripts/test.py

* **/myco_arm_controller/joint_trajectory (trajectory_msgs/msg/JointTrajectory)**  
This topic contain a trajectory. When you publish this topic, the robot will move along the trajectory.
example: function_pub_trajectory() in myco_basic_api/scripts/test.py

* **/myco_teleop_joint_cmd_no_limit (std_msgs/msg/Int64)**  
...
* **/myco_arm_controller/state (control_msgs/msg/JointTrajectoryControllerState)**  
...
* **/write_do (myco_robot_msgs/srv/MycoIODWrite)**
Write a value into DO  

* **/read_di (myco_robot_msgs/srv/MycoIODRead)**  
...
* **myco_module_open_brake_slaveX(std_srvs/srv/SetBool)**  
When the module is not enabled, you can open the brake of the corresponding module using this service.  

* **myco_module_close_brake_slaveX(std_srvs/srv/SetBool)**  
