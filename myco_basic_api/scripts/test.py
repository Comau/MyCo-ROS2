...
class test(object):
    def __init__(self):
        ...
        self.trajectory_cmd = self.node.create_publisher(JointTrajectory,'/myco_arm_controller/joint_trajectory',1)

    def function_pub_joints(self):
        robot_state = JointState()
        robot_state.name = ['myco_joint1','myco_joint2','myco_joint3',
    ...
    def function_pub_cart(self):
        ...
        robot_state.header.frame_id = 'myco_base_link'
        robot_state.header.stamp = self.node.get_clock().now().to_msg()
    ...
    def function_pub_cart_path(self):
        ...
        # myco3 0.325 0 0.305 0 1 0 0
        # myco5 0.42 0 0.445 0 1 0 0
        # myco5_l 0.495 0 0.52 0 1 0 0
        # myco10 0.52 0 0.565 0 1 0 0
        # myco10_l 0.7 0 0.685 0 1 0 0
        # myco15 0.57 0 0.82 0 1 0 0
    ...
    def function_pub_trajectory(self):
        self.joint1_name='myco_joint1'
        self.joint2_name='myco_joint2'
        self.joint3_name='myco_joint3'
        self.joint4_name='myco_joint4'
        self.joint5_name='myco_joint5'
        self.joint6_name='myco_joint6'
